...
HD_PWD='C:/fpga_labs_sp18/lab5/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_testbench.tcl
