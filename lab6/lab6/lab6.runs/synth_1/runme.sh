...
HD_PWD='C:/fpga_labs_sp18/lab6/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_controller_testbench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_controller_testbench.tcl
