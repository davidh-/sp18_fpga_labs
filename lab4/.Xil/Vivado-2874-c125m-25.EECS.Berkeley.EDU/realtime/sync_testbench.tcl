...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-2874-c125m-25.EECS.Berkeley.EDU/realtime/tmp"
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-2874-c125m-25.EECS.Berkeley.EDU/"
